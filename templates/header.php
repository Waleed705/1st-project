...
<div class="header">
    <div class="logo">
        <img src="../images/logo.png" alt=""  class="img-logoi">
    </div>
    <div class="con-btn">
...
<script>
    ...
    function services() {
        window.location.href = "http://localhost/php/project/templates/services.php"
    }
    function update() {
        window.location.href = "http://localhost/php/project/templates/update_profile.php"
    }
    function logOut() {
        window.location.href = "http://localhost/php/project/templates/logout.php"
    }
    function about() {
        window.location.href = "http://localhost/php/project/templates/about.php"
    }
